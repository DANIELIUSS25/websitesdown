    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div style={{ width: "100%", maxWidth: 400 }}>
        ...
        <div style={{ borderRadius: 16, background: S.s1, border: `1px solid ${S.e1}`, padding: "32px 28px" }}>
          <h1 style={{ fontSize: 22, fontWeight: 800, letterSpacing: "-0.04em", marginBottom: 6 }}>Create account</h1>
          <p style={{ fontSize: 13, color: S.t3, marginBottom: 28 }}>Start monitoring your websites</p>
          ...
          <p style={{ fontSize: 12.5, color: S.t4, textAlign: "center", marginTop: 20 }}>
            ...
            <a href="/auth/login" style={{ color: S.ac, textDecoration: "none", fontWeight: 600 }}>Sign in</a>
          </p>
        </div>
      </div>
    </div>
